...
|--------|------|------|-----------|
| `9b19700e623f` | arm64: fpsimd: Drop unneeded 'busy' flag | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20231208113218.3001940-7-ardb@google.com/) |
| `aefbab8e77eb` | arm64: fpsimd: Preserve/restore kernel mode NEON at context switch | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20231208113218.3001940-8-ardb@google.com/) |
| `2632e2521769` | arm64: fpsimd: Implement lazy restore for kernel mode FPSIMD | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20231208113218.3001940-9-ardb@google.com/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `b8995a184170` | Revert "arm64: fpsimd: Implement lazy restore for kernel mode FPSIMD" | [通用] [OE缺失] | (同系列, 无独立 lore link) |
| `f481bb32d60e` | Reapply "arm64: fpsimd: Implement lazy restore for kernel mode FPSIMD" | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240522091335.335346-2-ardb+git@google.com/) |
| `e92bee9f861b` | **arm64/fpsimd: Avoid erroneous elide of user state reload** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240522091335.335346-2-ardb+git@google.com/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `9533864816fb` | **arm64/sme: Restore SME registers on exit from suspend** | [通用] [OE已合] | [link](https://lore.kernel.org/all/20240213-arm64-sme-resume-v3-1-17e05e493471@kernel.org/) |
| `d7b77a0d565b` | **arm64/sme: Restore SMCR_EL1.EZT0 on exit from suspend** | [通用] [OE已合] | [link](https://lore.kernel.org/all/20240213-arm64-sme-resume-v3-2-17e05e493471@kernel.org/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `61da7c8e2a60` | **arm64/signal: Don't assume that TIF_SVE means we saved SVE state** | [通用] [OE已合] | [link](https://lore.kernel.org/all/20240130-arm64-sve-signal-regs-v2-1-9fc6f9502782@kernel.org/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `d3a181588df9` | arm64/fpsimd: Add fpsimd_save_and_flush_current_state() | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250409164010.3480271-11-mark.rutland@arm.com/) |
| `929fa99b1215` | **arm64/fpsimd: signal: Always save+flush state early** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250409164010.3480271-13-mark.rutland@arm.com/) |
| `c94f2f326146` | **arm64/fpsimd: Fix merging of FPSIMD state during signal return** | [通用] [OE已合] | [link](https://lore.kernel.org/all/20250409164010.3480271-10-mark.rutland@arm.com/) |

#### 涉及的 commits (arch/arm64/kernel/signal.c) — 均属于同一个 v2 系列

| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `99560c9452bb` | arm64/fpsimd: signal: Use SMSTOP behaviour in setup_return() | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250409164010.3480271-12-mark.rutland@arm.com/) |
| `2fe2b96c3818` | arm64/fpsimd: signal: Simplify preserve_tpidr2_context() | [通用] [OE缺失] | 同系列 |
| `b376108e1f88` | arm64/fpsimd: signal: Clear TPIDR2 when delivering signals | [通用] [OE缺失] | 同系列 |
| `1bf663a86a45` | arm64/fpsimd: signal: Clear PSTATE.SM when restoring FPSIMD frame only | [通用] [OE缺失] | 同系列 |
| `b465ace42620` | arm64/fpsimd: signal: Mandate SVE payload for streaming-mode state | [通用] [OE缺失] | 同系列 |
| `be625d803c3b` | arm64/fpsimd: signal: Consistently read FPSIMD context | [通用] [OE缺失] | 同系列 |
| `ea8ccfddbce0` | arm64/fpsimd: signal: Allocate SSVE storage when restoring ZA | [通用] [OE缺失] | 同系列 |
| `d2907cbe9ea0` | **arm64/fpsimd: signal: Fix restoration of SVE context** | [通用] [OE缺失] | 同系列 |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `dc7eb8755797` | **arm64/sme: Always exit sme_alloc() early with existing storage** | [通用] [OE已合] | [link](https://lore.kernel.org/all/20240115-arm64-sme-flush-v1-1-7472bd3459b7@kernel.org/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `8410186ca480` | **arm64/fpsimd: Remove spurious check for SVE support** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240115-arm64-sve-enabled-check-v1-1-a26360b00f6d@kernel.org/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `2813926261e4` | **arm64/sve: Lower the maximum allocation for the SVE ptrace regset** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240213-arm64-sve-ptrace-regset-size-v2-1-c7600ca74b9b@kernel.org/) |
...
|--------|------|------|------|-----------|
| `203f2b95a882` | **arm64/fpsimd: Support FEAT_FPMR** | [FPMR] [OE缺失] | fpsimd.c | [link](https://lore.kernel.org/all/20240306-arm64-2023-dpisa-v5-3-c568edc8ed7f@kernel.org/) |
| `4035c22ef7d4` | arm64/ptrace: Expose FPMR via ptrace | [FPMR] [OE缺失] | ptrace.c | [link](https://lore.kernel.org/all/20240306-arm64-2023-dpisa-v5-4-c568edc8ed7f@kernel.org/) |
| `8c46def44409` | arm64/signal: Add FPMR signal handling | [FPMR] [OE缺失] | signal.c | [link](https://lore.kernel.org/all/20240306-arm64-2023-dpisa-v5-5-c568edc8ed7f@kernel.org/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `2f0090549b64` | **arm64/sve: Ensure that all fields in ZCR_EL1 are set to known values** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240213-arm64-fp-init-vec-cr-v1-1-7e7c2d584f26@kernel.org/) |
| `93576e349887` | **arm64/sme: Ensure that all fields in SMCR_EL1 are set to known values** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240213-arm64-fp-init-vec-cr-v1-2-7e7c2d584f26@kernel.org/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `751ecf6afd65` | **arm64/sve: Discard stale CPU state when handling SVE traps** | [通用] [OE已合] | [link](https://lore.kernel.org/all/20241030-arm64-fpsimd-foreign-flush-v1-1-bd7bd66905a2@kernel.org/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `f5d71291841a` | **arm64: ptrace: fix partial SETREGSET for NT_ARM_FPMR** | [FPMR] [OE缺失] | [link](https://lore.kernel.org/all/20241205121655.1824269-3-mark.rutland@arm.com/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `b017a0cea627` | **arm64/ptrace: Use saved floating point state type to determine SVE layout** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240325-arm64-ptrace-fp-type-v1-1-8dc846caf11f@kernel.org/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `7d9c1ed6f4bf` | KVM: arm64: Move FPMR into the sysreg array | [FPMR] [OE缺失] | [link](https://lore.kernel.org/all/20240820131802.3547589-4-maz@kernel.org/) |
| `ef3be86021c3` | KVM: arm64: Add save/restore support for FPMR | [FPMR] [OE缺失] | [link](https://lore.kernel.org/all/20240820131802.3547589-5-maz@kernel.org/) |
| `b8f669b491ec` | KVM: arm64: Honor trap routing for FPMR | [FPMR] [OE缺失] | [link](https://lore.kernel.org/all/20240820131802.3547589-6-maz@kernel.org/) |
| `c9150a8ad9cd` | KVM: arm64: Enable FP8 support when available and configured | [FPMR] [OE缺失] | [link](https://lore.kernel.org/all/20240820131802.3547589-8-maz@kernel.org/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `fbc7e61195e2` | **KVM: arm64: Unconditionally save+flush host FPSIMD/SVE/SME state** | [通用] [OE已合] | [link](https://lore.kernel.org/all/20250210195226.1215254-2-mark.rutland@arm.com/) |
| `8eca7f6d5100` | KVM: arm64: Remove host FPSIMD saving for non-protected KVM | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250210195226.1215254-3-mark.rutland@arm.com/) |
| `407a99c4654e` | KVM: arm64: Remove VHE host restore of CPACR_EL1.SMEN | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250210195226.1215254-5-mark.rutland@arm.com/) |
| `459f059be702` | KVM: arm64: Remove VHE host restore of CPACR_EL1.ZEN | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250210195226.1215254-6-mark.rutland@arm.com/) |
| `59419f10045b` | **KVM: arm64: Eagerly switch ZCR_EL{1,2}** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250210195226.1215254-9-mark.rutland@arm.com/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `2e3cf82063a0` | **KVM: arm64: nv: Ensure correct VL is loaded before saving SVE state** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240620164653.1130714-8-oliver.upton@linux.dev/) |
| `399debfc9749` | KVM: arm64: nv: Forward SVE traps to guest hypervisor | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240620164653.1130714-3-oliver.upton@linux.dev/) |
| `d2b2ec8ba8dd` | KVM: arm64: nv: Forward FP/ASIMD traps to guest hypervisor | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240620164653.1130714-2-oliver.upton@linux.dev/) |
| `f1ee914fb626` | KVM: arm64: Allow the use of SVE+NV | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240620164653.1130714-15-oliver.upton@linux.dev/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `afb91f5f8ad7` | **KVM: arm64: Ensure that SME controls are disabled in protected mode** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240603122852.3923848-10-tabba@google.com/) |
| `b5b9955617bc` | KVM: arm64: Eagerly restore host fpsimd/sve state in pKVM | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240603122852.3923848-7-tabba@google.com/) |
| `e511e08a9f49` | KVM: arm64: Specialize handling of host fpsimd state on trap | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240603122852.3923848-6-tabba@google.com/) |
| `66d5b53e20a6` | KVM: arm64: Allocate memory mapped at hyp for host sve state in pKVM | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240603122852.3923848-5-tabba@google.com/) |
| `87bb39ed40bd` | KVM: arm64: Reintroduce __sve_save_state | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240603122852.3923848-3-tabba@google.com/) |
| `d48965bc47e4` | KVM: arm64: Do not map the host fpsimd state to hyp in pKVM | [通用] [OE缺失] | 同系列 |
| `f11290e0aa6e` | KVM: arm64: Refactor checks for FP state ownership | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20240603122852.3923848-9-tabba@google.com/) |
| `5294afdbf45a` | KVM: arm64: Exclude FP ownership from kvm_vcpu_arch | [通用] [OE缺失] | 同系列 |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `d3eaab3c7090` | **arm64/fpsimd: Discard stale CPU state when handling SME traps** | [通用] [OE已合] | [link](https://lore.kernel.org/all/20241204-arm64-sme-reenable-v2-1-bae87728251d@kernel.org/) |
| `e5fa85fce08b` | **arm64/fpsimd: Don't corrupt FPMR when streaming mode changes** | [FPMR] [OE缺失] | [link](https://lore.kernel.org/all/20241204-arm64-sme-reenable-v2-2-bae87728251d@kernel.org/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `95507570fb2f` | **arm64/fpsimd: Avoid RES0 bits in the SME trap handler** | [通用] [OE已合] | [link](https://lore.kernel.org/all/20250409164010.3480271-2-mark.rutland@arm.com/) |
| `45fd86986b79` | arm64/fpsimd: Remove redundant SVE trap manipulation | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250409164010.3480271-4-mark.rutland@arm.com/) |
| `d7649a4a601e` | **arm64/fpsimd: Remove opportunistic freeing of SME state** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250409164010.3480271-5-mark.rutland@arm.com/) |
| `01098d893fa8` | **arm64/fpsimd: Avoid clobbering kernel FPSIMD state with SMSTOP** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250409164010.3480271-8-mark.rutland@arm.com/) |
| `a90878f297d3` | **arm64/fpsimd: Reset FPMR upon exec()** | [FPMR] [OE缺失] | [link](https://lore.kernel.org/all/20250409164010.3480271-9-mark.rutland@arm.com/) |
| `61db0e0ba398` | arm64/fpsimd: Remove unused fpsimd_force_sync_to_sve() | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250409164010.3480271-3-mark.rutland@arm.com/) |
| `f699c66691fb` | arm64/fpsimd: Avoid warning when sve_to_fpsimd() is unused | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250430173240.4023627-1-mark.rutland@arm.com/) (独立 patch) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `6ef1d778ce56` | arm64/fpsimd: Add task_smstop_sm() | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-9-mark.rutland@arm.com/) |
| `8738288a08b8` | arm64/fpsimd: Factor out {sve,sme}_state_size() helpers | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-8-mark.rutland@arm.com/) |
| `b255be426913` | arm64/fpsimd: Clarify sve_sync_*() functions | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-7-mark.rutland@arm.com/) |
| `b87c8c4aca11` | **arm64/fpsimd: ptrace/prctl: Ensure VL changes leave task in a valid state** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-16-mark.rutland@arm.com/) |
| `49ce484187f7` | **arm64/fpsimd: ptrace/prctl: Ensure VL changes do not resurrect stale data** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-15-mark.rutland@arm.com/) |
| `316283f276eb` | **arm64/fpsimd: ptrace: Consistently handle partial writes to NT_ARM_(S)SVE** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-6-mark.rutland@arm.com/) |
| `398edaa12f9c` | **arm64/fpsimd: Do not discard modified SVE state** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-2-mark.rutland@arm.com/) |

### 涉及的 commits (ptrace.c)

| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `054d627c5554` | arm64/fpsimd: ptrace: Save task state before generating SVE header | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-11-mark.rutland@arm.com/) |
| `b93e685ecff7` | arm64/fpsimd: ptrace: Do not present register data for inactive mode | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-12-mark.rutland@arm.com/) |
| `f916dd32a943` | arm64/fpsimd: ptrace: Mandate SVE payload for streaming-mode state | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-13-mark.rutland@arm.com/) |
| `9f8bf718f292` | arm64/fpsimd: ptrace: Gracefully handle errors | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-14-mark.rutland@arm.com/) |
| `472800cd5e38` | arm64/sme: Support disabling streaming mode via ptrace on SME only systems | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-20-mark.rutland@arm.com/) |
| `128a7494a9f1` | **arm64/fpsimd: ptrace: Fix SVE writes on !SME systems** | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250508132644.1395904-10-mark.rutland@arm.com/) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `4fa617cc6851` | **arm64/fpsimd: Allocate kernel mode FP/SIMD buffers on the stack** | [通用] [OE缺失] | (无独立 lore link，含在 merge tag 中) |
...
| Commit | 标题 | 标记 | Lore Link |
|--------|------|------|-----------|
| `7137a203b251` | arm64/fpsimd: Permit kernel mode NEON with IRQs off | [通用] [OE缺失] | (多 patch 系列，无独立 lore link) |
| `1d038e801833` | arm64/fpsimd: Don't warn when EFI execution context is preemptible | [通用] [OE缺失] | 同上 |
| `e04796c8b598` | arm64/fpsimd: Avoid unnecessary per-CPU buffers for EFI runtime calls | [通用] [OE缺失] | [link](https://lore.kernel.org/all/20250318132421.3155799-2-ardb+git@google.com/) |
| `63de2b3859ba` | arm64/efi: Remove unneeded SVE/SME fallback preserve/store handling | [通用] [OE缺失] | 同系列 |
...
|--------|------|------|-----------|
| `525fd6a1b34e` | v6.13 | [通用] [OE缺失] | arm64/fpsimd: Fix a typo | (trivial) |
| `19dd484cd19c` | v6.15 | [通用] [OE缺失] | arm64/fpsimd: simplify sme_setup() | (优化) |
| `334a1a1e1a5f` | v6.18 | [通用] [OE缺失] | KVM: arm64: Fix comment in fpsimd_lazy_switch_to_host() | (comment fix) |
| `da2e743419cb` | v6.18 | [通用] [OE缺失] | KVM: arm64: VHE: Save and restore host MDCR_EL2 value correctly | [link](https://lore.kernel.org/all/20250319235444.1334756-3-oliver.upton@linux.dev/) |
| `fed55f49fad1` | v6.17 | [通用] [OE缺失] | arm64: errata: Work around AmpereOne's erratum AC04_CPU_23 | (erratum workaround) |
...
|--------|------|------|-------------|
| `d3a181588df9` | arm64/fpsimd: Add fpsimd_save_and_flush_current_state() | [通用] [OE缺失] | [PATCH v2 00/13] Preparatory FPSIMD/SVE/SME fixes |
...
| Commit | 标题 | 标记 | Cover Letter |
|--------|------|------|-------------|
| `203f2b95a882` | arm64/fpsimd: Support FEAT_FPMR | [FPMR] [OE缺失] | [PATCH v5 0/8] Support for 2023 DPISA extensions |
| `4035c22ef7d4` | arm64/ptrace: Expose FPMR via ptrace | [FPMR] [OE缺失] | (同上) |
| `8c46def44409` | arm64/signal: Add FPMR signal handling | [FPMR] [OE缺失] | (同上) |
...
| Commit | 标题 | 标记 | Cover Letter |
|--------|------|------|-------------|
| `751ecf6afd65` | arm64/sve: Discard stale CPU state when handling SVE traps | [通用] [OE已合] | [PATCH 0/2] Fix missing invalidation when working with foreign FP state |
| `d3eaab3c7090` | arm64/fpsimd: Discard stale CPU state when handling SME traps | [通用] [OE已合] | [PATCH v2 0/6] arm64/sme: Collected SME fixes |
...
| Commit | 标题 | 标记 | Cover Letter |
|--------|------|------|-------------|
| `95507570fb2f` | arm64/fpsimd: Avoid RES0 bits in the SME trap handler | [通用] [OE已合] | [PATCH v2 00/13] Preparatory FPSIMD/SVE/SME fixes |
| `e5fa85fce08b` | arm64/fpsimd: Don't corrupt FPMR when streaming mode changes | [FPMR] [OE缺失] | [PATCH v2 0/6] arm64/sme: Collected SME fixes |
| `01098d893fa8` | arm64/fpsimd: Avoid clobbering kernel FPSIMD state with SMSTOP | [通用] [OE缺失] | [PATCH v2 00/13] Preparatory FPSIMD/SVE/SME fixes |
| `a90878f297d3` | arm64/fpsimd: Reset FPMR upon exec() | [FPMR] [OE缺失] | (同上) |
| `c94f2f326146` | arm64/fpsimd: Fix merging of FPSIMD state during signal return | [通用] [OE已合] | (同上) |
| `929fa99b1215` | arm64/fpsimd: signal: Always save+flush state early | [通用] [OE缺失] | (同上) |
...
| Commit | 标题 | 标记 | Cover Letter |
|--------|------|------|-------------|
| `7d9c1ed6f4bf` | KVM: arm64: Move FPMR into the sysreg array | [FPMR] [OE缺失] | [PATCH v4 0/8] KVM: arm64: Add support for FP8 |
| `ef3be86021c3` | KVM: arm64: Add save/restore support for FPMR | [FPMR] [OE缺失] | (同上) |
| `b8f669b491ec` | KVM: arm64: Honor trap routing for FPMR | [FPMR] [OE缺失] | (同上) |
| `c9150a8ad9cd` | KVM: arm64: Enable FP8 support when available and configured | [FPMR] [OE缺失] | (同上) |
...
| Commit | 标题 | 标记 | Cover Letter |
|--------|------|------|-------------|
| `fbc7e61195e2` | KVM: arm64: Unconditionally save+flush host FPSIMD/SVE/SME state | [通用] [OE已合] | [PATCH v3 0/8] KVM: arm64: FPSIMD/SVE/SME fixes |
| `8eca7f6d5100` | KVM: arm64: Remove host FPSIMD saving for non-protected KVM | [通用] [OE缺失] | (同上) |
| `407a99c4654e` | KVM: arm64: Remove VHE host restore of CPACR_EL1.SMEN | [通用] [OE缺失] | (同上) |
| `459f059be702` | KVM: arm64: Remove VHE host restore of CPACR_EL1.ZEN | [通用] [OE缺失] | (同上) |
| `59419f10045b` | KVM: arm64: Eagerly switch ZCR_EL{1,2} | [通用] [OE缺失] | (同上) |
...
| Commit | 标题 | 标记 | Cover Letter |
|--------|------|------|-------------|
| `f699c66691fb` | arm64/fpsimd: Avoid warning when sve_to_fpsimd() is unused | [通用] [OE缺失] | (单 patch, 无 cover) |
...
以下针对 **openEuler OLK-6.6 + VHE only** 场景。已通过代码检查确认 openEuler 6.6 的回合状态。[通用][OE已合] 的补丁无需回合。

##### 整体说明

openEuler OLK-6.6 的 fpsimd 代码基线与 upstream v6.6 基本一致，但已选择性回合了部分通用修复。FPMR 相关代码**完全不存在**——`SYS_FPMR` 未定义、`system_supports_fpmr()` 不存在、信号/ptrace/KVM 均无 FPMR 处理。此外 kernel NEON context switch 系列（`aefbab8e77eb` 等）也未回合，即 `fpsimd_save_user_state()` 不存在。

##### 已存在于 openEuler 6.6 的补丁（无需回合）

| 补丁 | 说明 |
|------|------|
| 通用 SME suspend/resume (`9533864816fb`, `d7b77a0d565b`) | SME 休眠恢复 |
| 通用 signal TIF_SVE 修复 (`61da7c8e2a60`) | 信号保存格式检查 |
| 通用 sme_alloc 修复 (`dc7eb8755797`) | SME 状态分配 |
| 通用 SVE/SME trap 竞争修复 (`751ecf6afd65`, `d3eaab3c7090`) | Trap 竞争 |
| 通用 RES0 bits 修复 (`95507570fb2f`) | SME trap handler |
| 通用信号合并修复 (`c94f2f326146`) | 信号返回 FPSIMD 合并 |
| KVM host FP 无条件 save+flush (`fbc7e61195e2`) | KVM FP 管理 |

**特别注意**: openEuler 的 KVM fpsimd.c 显示 `fbc7e61195e2` 已回合（`21cd4707ee94`），但它是**单独回合的**，缺少同系列的 `8eca7f6d5100`、`407a99c4654e`、`459f059be702`、`59419f10045b`。OE 为此打了两个 OE 专属修复: `d73af241f7c5` (Fix softirq masking) 和 `208d4f745a52` (Fix kernel BUG due to bad backport)，佐证了部分回合引入的问题。

##### openEuler 6.6 需回合的最小补丁集（VHE KVM 场景）

```
第1组: sysreg 基础设施 (v6.8, 前置依赖)
  e3a649ecf8b9  arm64/sysreg: Add definition for FPMR             [FPMR] [OE缺失]
  a6052284a9f9  arm64/sysreg: Update SCTLR_EL1 for DDI0601 2023-09 [FPMR] [OE缺失]
  126cb3a60d35  arm64/sysreg: Update HCRX_EL2 definition for DDI0601 2023-09 [FPMR] [OE缺失]

第2组: kernel NEON context switch (v6.8, 提供 fpsimd_save_user_state)
  9b19700e623f  arm64: fpsimd: Drop unneeded 'busy' flag           [通用] [OE缺失]
  aefbab8e77eb  arm64: fpsimd: Preserve/restore kernel mode NEON   [通用] [OE缺失]
  2632e2521769  arm64: fpsimd: Implement lazy restore               [通用] [OE缺失]
  e92bee9f861b  arm64/fpsimd: Avoid erroneous elide of user state  [通用] [OE缺失]

第3组: 基础设施 — fpsimd_save_and_flush_current_state (v6.14)
  d3a181588df9  arm64/fpsimd: Add fpsimd_save_and_flush_current_state() [通用] [OE缺失]

第4组: FEAT_FPMR / FP8 特性使能 (v6.9)
  b6c0b424cb91  arm64/fpsimd: Enable host kernel access to FPMR     [FPMR] [OE缺失]
  203f2b95a882  arm64/fpsimd: Support FEAT_FPMR                     [FPMR] [OE缺失]
  4035c22ef7d4  arm64/ptrace: Expose FPMR via ptrace               [FPMR] [OE缺失]
  8c46def44409  arm64/signal: Add FPMR signal handling             [FPMR] [OE缺失]

第5组: FPMR Bug 修复 (v6.14)
  e5fa85fce08b  arm64/fpsimd: Don't corrupt FPMR when streaming mode changes [FPMR] [OE缺失]
  a90878f297d3  arm64/fpsimd: Reset FPMR upon exec()               [FPMR] [OE缺失]
  01098d893fa8  arm64/fpsimd: Avoid clobbering kernel FPSIMD with SMSTOP  [通用] [OE缺失]
  929fa99b1215  arm64/fpsimd: signal: Always save+flush state early [通用] [OE缺失]
  f5d71291841a  arm64: ptrace: fix partial SETREGSET for NT_ARM_FPMR [FPMR] [OE缺失]

第6组: KVM FPMR/FP8 支持 (v6.12)
  7d9c1ed6f4bf  KVM: arm64: Move FPMR into the sysreg array        [FPMR] [OE缺失]
  ef3be86021c3  KVM: arm64: Add save/restore support for FPMR      [FPMR] [OE缺失]
  b8f669b491ec  KVM: arm64: Honor trap routing for FPMR            [FPMR] [OE缺失]
  c9150a8ad9cd  KVM: arm64: Enable FP8 support when available      [FPMR] [OE缺失]

第7组: KVM Host FP 管理完善 (v6.14, fbc7e61195e2 已回合, 补充剩余)
  8eca7f6d5100  KVM: arm64: Remove host FPSIMD saving for non-protected KVM [通用] [OE缺失]
  407a99c4654e  KVM: arm64: Remove VHE host restore of CPACR_EL1.SMEN      [通用] [OE缺失]
  459f059be702  KVM: arm64: Remove VHE host restore of CPACR_EL1.ZEN        [通用] [OE缺失]
  59419f10045b  KVM: arm64: Eagerly switch ZCR_EL{1,2}                      [通用] [OE缺失]

第8组: 编译修复
  f699c66691fb  arm64/fpsimd: Avoid warning when sve_to_fpsimd() is unused [通用] [OE缺失]
```
...
第 1-3 组是硬依赖链（sysreg → kernel NEON → save_and_flush），必须先合。第 4 组 FPMR 使能依赖第 1-3 组。第 5-6 组修复依赖第 4 组。第 7 组完善 KVM FP 管理（openEuler 已合 `fbc7e61195e2` 但缺配套补丁，可能导致问题）。第 8 组修复编译 warning。

**不需要回合的系列**: KVM NV SVE（无 NV）、pKVM FP 修复（无 pKVM）、SVE/SME trap 竞争（已合）、信号合并（已合）。

**注意**: openEuler 已合的 `fbc7e61195e2` 是单独 cherry-pick 的，缺少配套 patch `8eca7f6d5100` 等。这意味着第 7 组不仅是"清理"，而是对 KVM FP 状态管理完整性的必要补充。回合第 7 组后需验证 OE 专属补丁 `208d4f745a52` 是否仍然需要。
